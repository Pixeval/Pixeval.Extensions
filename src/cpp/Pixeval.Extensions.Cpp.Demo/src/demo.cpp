...
namespace
{
    ...
    public:
        ...
        [[nodiscard]] std::span<ExtensionObjectBase* const> extensions() noexcept override { return {extensions_.data(), extensions_.size()}; }
    ...
    private:
        ...
        std::vector<ExtensionObjectBase*> extensions_;
    };
